...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-purple-600/20 rounded-full blur-[100px] -z-10 pointer-events-none"></div>
      <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-brand-600/20 rounded-full blur-[100px] -z-10 pointer-events-none"></div>
      ...
      <div className="w-full max-w-md">
        <div className="glass-card p-8 md:p-10 relative">
          ...
          <div className="absolute -top-6 -right-6 p-4 bg-gradient-to-bl from-purple-500 to-brand-600 rounded-2xl shadow-xl shadow-purple-500/20 -rotate-12">
            <Sparkles className="w-8 h-8 text-white" />
          </div>

          <div className="mb-10 text-center">
            <h1 className="text-3xl font-bold mb-2 text-gradient">Create Account</h1>
            <p className="text-gray-400 text-sm">Join StaxTech and start sharing your journey</p>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-400">
            ...
            <Link to="/blog/Login" className="text-brand-400 hover:text-brand-300 font-medium transition-colors">
              Sign In
            </Link>
          </p>
        </div>
